...
class PatchEmbed(nn.Module):
    def __init__(self, input_shape=[224,224], patch_size=16, in_chans=3, num_features=768, norm_layer=None):
        super().__init__()
        self.num_patchs = (input_shape[0] // patch_size) * (input_shape[1] // patch_size)
...
def vit_b_16(input_shape=[224, 224], num_classes=1000):
    model = VisionTransformer(input_shape, num_classes=num_classes)
    return model